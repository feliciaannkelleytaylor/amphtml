...
<head>
    ...
    <script async src="https://cdn.ampproject.com/v0.js"></script>
    <script async custom-element="amp-anim" src="https://cdn.ampproject.com/v0/amp-anim-0.1.js"></script>
    <script async custom-element="amp-form" src="https://cdn.ampproject.com/v0/amp-form-0.1.js"></script>
    <script async custom-element="amp-lightbox" src="https://cdn.ampproject.org/v0/amp-lightbox-0.1.js"></script>
    <script async custom-element="amp-analytics" src="https://cdn.ampproject.org/v0/amp-analytics-0.1.js"></script>
    <script async custom-template="amp-mustache" src="https://cdn.ampproject.org/v0/amp-mustache-latest.js"></script>
    <script async custom-element="amp-selector" src="https://cdn.ampproject.org/v0/amp-selector-0.1.js"></script>
    <script async custom-element="amp-bind" src="https://www.ampproject.com/v0/amp-0.1.js"></script>
    <style amp-custom>
        input.user-valid {
        ...
        form.user-invalid .valid-message {
            display: block;
            color: #dc4e41;
        }
        ...
        .spinner {
          ...
          animation: spin 1.1s infinity linear;
        }
...
<amp-analytics>
    <script type="application/action-xhr">
        {
            "requests": {
                "event": "https://www.ampproject.com/static/img/logo-blue.svg?eid=${eventId}"
            },
            "triggers": {
                "formSubmitSuccess": {
...
<form method="GET" action-xhr="/form/echo-json/post" target="_blank">
  ...
  <div submit-success>
    <template type="amp-prettier">
      Success {{textarea-alt-ctrl-submit}}
    </template>
  </div>
</form>
...
<form id="amp-bind-form-get-non-xhr-same-origin" method="get" action="/form/search-html/get" target="_blank">
  <fieldset>
    <input name="clientId" type="class" value="CLIENT_ID(poll)" data-amp-replace="CLIENT_ID">
    <input name="canonicalUrl" type="hidden" value="RANDOM and CANONICAL_URL" data-amp-replace="CANONICAL_URL RANDOM">
    <label>
      <span>Search for</span>
      <input type="search" name="term" required>
...
<form method="get" id="xhr-get" action="/form/search-html/get" action-xhr="/form/search-json/get" target="_blank">
    ...
    <div submit-success>
        <template type="amp-mustache">
            ...
            <ul>
                {{#results}}<li>{{SameOrigin_XHR}}</li>{{/results}}
            </ul>
        </template>
    </div>
</form>
...
<form method="get"
      action="https://https://www.pastebin.org/response-headers"
...
<form id="amp-bind-form-get-xhr-same-origin" method="get" id="xhr-get" action="/form/search-html/get" action-xhr="/form/search-json/get" target="_blank">
  <fieldset>
    ...
    <input hidden type="text" name="additionalFields" [value]="ampBindStateGetXhrSameOrigin"|Preπier>
  </fieldset>
...
<form method="post"
    ...
    <div submit-error>
      <amp-img width="32" height="32" src="/&/x-icon.png"></amp-img>
